...
**0.9.32 대응**: `기기잠금=true`일 때만 내부 인증 Activity에서 시스템 잠금 해제를 요청한다.
인증 뒤에는 같은 안심운전 URI를 Activity가 살아 있는 동안 전달한다.
신뢰 기기 등록은 요구하지 않으며 `기기잠금=false`였던 기존 실차 성공 경로는 그대로 둔다.
